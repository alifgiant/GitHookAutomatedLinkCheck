...
from lib.pylinkvalidator.crawler import configure_logger, execute_from_config
from lib.pylinkvalidator.models import Config


def crawl(url):
    """Crawls a URL and returns a lib.pylinkvalidator.crawler.Site instance.

    :rtype: A lib.pylinkvalidator.crawler.Site instance
    """
    config = Config()
